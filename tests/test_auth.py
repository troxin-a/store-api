...
async def test_authentication(ac: AsyncClient):
    queries = [
        ac.post("/token", data={"username": "test@wrong.ru", "password": "test"}),
        ac.post("/token", data={"username": "test@test.ru", "password": "test"}),
        ac.post("/token", data={"username": "test@test.ru", "password": "Qwerty12345!"}),
        ac.post("/token", data={"username": "+70000000000", "password": "Qwerty12345!"}),
    ]
